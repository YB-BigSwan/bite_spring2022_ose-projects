...
function showLibraryInfo(jsonText) {
	...
	var outputText =
		libraryObject.items[0].name.en +
		'<br>' +
		libraryObject.items[0].address.street.en +
		'<br>' +
		libraryObject.items[0].address.zipcode +
		' ' +
		libraryObject.items[0].address.city.en +
		'<br> ';
	...
	document.getElementById('pOutput').innerHTML =
		outputText +
		'<br> <a href=" ' +
		libraryObject.items[0].homepage.en +
		'" target="blank"> Homepage </a> <br>';
}
