...
function translateTo(language) {
	...
	for (
		var index = 0;
		wordFound === false && index < wordArray.length;
		index++
	) {
...
var wordArray = [
	...
	{ englishWord: 'hi', finnishWord: 'moi', swedishWord: 'hej' },
	{ englishWord: 'tired', finnishWord: 'väsynyt', swedishWord: 'trött' },
	{ englishWord: 'computer', finnishWord: 'tietokone', swedishWord: 'dator' },
];
